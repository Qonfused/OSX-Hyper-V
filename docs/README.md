...
<div align="center">
  ...
  <a href="https://github.com/acidanthera/OpenCorePkg/releases">![OpenCore](https://img.shields.io/badge/dynamic/yaml?label=OpenCore&logo=Osano&logoColor=0298e1&labelColor=3f4451&prefix=v&query=OpenCorePkg.version&url=https://raw.githubusercontent.com/Qonfused/OSX-Hyper-V/main/src/build.lock)</a>
...
> **Note** After building this project's EFI, you can run the [`create-virtual-machine.ps1`](/scripts/create-virtual-machine.ps1) script in powershell (Windows) to quickly bootstrap a new virtual-machine.
...
You can use the [`convert-efi-disk.ps1`](/scripts/convert-efi-disk.ps1) script to perform the following steps for this section:

```powershell
# Use the dist folder generated by OCE-Build
scripts\convert-efi-disk.ps1

# Use a custom EFI and output path
scripts\convert-efi-disk.ps1 `
  -path "$env:USERPROFILE\Downloads\EFI" `
  -dest "$env:USERPROFILE\Desktop\EFI.vhdx"

# This script creates a VHDX disk and moves the specified EFI folder.
```
